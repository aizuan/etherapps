...
public class RecordActivity2 extends AppCompatActivity {
    ...
    public String userid, a, b, c, d, e;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayAdapter4 = new ArrayAdapter<String>(this, android.R.layout.simple_expandable_list_item_1, items2);
        arrayAdapter5 = new ArrayAdapter<String>(this, android.R.layout.simple_expandable_list_item_1, items3);
                                        ...
                                        ref3.addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                                    ...
                                                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                                                        String selected_item= String.valueOf(adapterView.getItemAtPosition(position));
                                                        DatabaseReference ref4 = ref3.child(selected_item);
                                                        ref4.addValueEventListener(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                ...
                                                                lv.setAdapter(arrayAdapter4);

                                                                lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                                                    @Override
                                                                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                                                                        String selected_item= String.valueOf(adapterView.getItemAtPosition(position));
                                                                        DatabaseReference ref5 = ref4.child(selected_item);
                                                                        ref5.addValueEventListener(new ValueEventListener() {
                                                                            ...
                                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                ...
                                                                                while (dit.hasNext()) {
                                                                                    DataSnapshot s = dit.next();
                                                                                    e = s.getValue().toString();
                                                                                    items3.add(getstring(e));
                                                                                }
